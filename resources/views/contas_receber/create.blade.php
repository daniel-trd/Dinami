...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow p-6 max-w-4xl mx-auto">
        ...
        <form method="POST" action="{{ route('contas_receber.store') }}" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    <label class="block text-sm text-gray-500 mb-1">Data Vencimento</label>
                    <input type="date" name="data_vencimento"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm">
                </div>

                <div>
                    <label class="block text-sm text-gray-500 mb-1">Data Pagamento</label>
