...
<div class="max-w-5xl mx-auto">
    ...
    <div class="relative flex items-center mb-6">
        ...
        <!-- Botão direita -->
        <div class="ml-auto">
            <a href="{{ route('configuracao.usuarios.index', $configuracao ?? 1) }}"
    ...
    <div class="bg-white rounded-2xl shadow p-6 max-w-4xl mx-auto">
        ...
        <form method="POST" action="{{ route('configuracao.usuarios.store', ['configuracao' => $configuracao]) }}">
    @csrf
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    <label class="block text-sm text-gray-500 mb-1">Senha</label>
