    ...
    <div class="flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('configuracao.usuarios.index', ['configuracao' => $configuracao, 'status' => 'ativo']) }}"
                    class="px-3 py-1.5 rounded-md text-sm {{ $status == 'ativo' ? 'bg-green-500 text-white' : 'bg-gray-100' }}">
                    Ativos
                </a>

                <a href="{{ route('configuracao.usuarios.index', ['configuracao' => $configuracao, 'status' => 'inativo']) }}"
        ...
        <div class="flex-1 flex justify-center">
            ...
            <form method="GET" action="{{ route('configuracao.usuarios.index', ['configuracao' => $configuracao]) }}">
        ...
        <div>
            ...
            <a href="{{ route('configuracao.usuarios.create', ['configuracao' => $configuracao]) }}"
        ...
        <div class="grid grid-cols-3 items-center">
            ...
            <div class="flex justify-end">
                ...
                <span class="text-sm text-gray-500 hidden sm:block">
                    ...
                    até <strong>{{ $usuarios->lastItem() }}</strong>
